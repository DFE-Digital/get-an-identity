...
public class ExistingAccountPhoneConfirmationTests : TestBase, IAsyncLifetime
{
    ...
    {
        await JourneyIsAlreadyCompleted_RedirectsToPostSignInUrl(additionalScopes: null, trnRequirementType: null, HttpMethod.Get, "/sign-in/register/existing-account-phone-confirmation");
    }

    [Fact]
    public async Task Get_JourneyHasExpired_RendersErrorPage()
    {
        await JourneyHasExpired_RendersErrorPage(_currentPageAuthenticationState(_existingUserAccount), additionalScopes: null, trnRequirementType: null, HttpMethod.Get, "/sign-in/register/existing-account-phone-confirmation");
    }
    ...
    public async Task Get_NullExistingAccountMobileNumber_RedirectsToExistingAccountConfirmEmail()
    {
        ...
        await GivenAuthenticationState_RedirectsTo(_currentPageAuthenticationState(_existingUserAccount), additionalScopes: null, trnRequirementType: null, HttpMethod.Get, "/sign-in/register/existing-account-phone-confirmation", "/sign-in/register/existing-account-email-confirmation");
    }

    [Fact]
    public async Task Get_ExistingAccountNotChosen_RedirectsToAccountExists()
    {
        await GivenAuthenticationState_RedirectsTo(_previousPageAuthenticationState(_existingUserAccount), additionalScopes: null, trnRequirementType: null, HttpMethod.Get, "/sign-in/register/existing-account-phone-confirmation", "/sign-in/register/account-exists");
    }
    ...
    {
        await JourneyIsAlreadyCompleted_RedirectsToPostSignInUrl(additionalScopes: null, trnRequirementType: null, HttpMethod.Post, "/sign-in/register/existing-account-phone-confirmation");
    }

    [Fact]
    public async Task Post_JourneyHasExpired_RendersErrorPage()
    {
        await JourneyHasExpired_RendersErrorPage(_currentPageAuthenticationState(_existingUserAccount), additionalScopes: null, trnRequirementType: null, HttpMethod.Post, "/sign-in/register/existing-account-phone-confirmation");
    }
    ...
    {
        _existingUserAccount!.MobileNumber = null;
        await GivenAuthenticationState_RedirectsTo(_currentPageAuthenticationState(_existingUserAccount), additionalScopes: null, trnRequirementType: null, HttpMethod.Post, "/sign-in/register/existing-account-phone-confirmation", "/sign-in/register/existing-account-email-confirmation");
    }

    [Fact]
    public async Task Post_ExistingAccountNotChosen_RedirectsToAccountExists()
    {
        await GivenAuthenticationState_RedirectsTo(_previousPageAuthenticationState(_existingUserAccount), additionalScopes: null, trnRequirementType: null, HttpMethod.Post, "/sign-in/register/existing-account-phone-confirmation", "/sign-in/register/account-exists");
    }
