...
public class ResendConfirmExistingAccountEmailTests : TestBase, IAsyncLifetime
{
    ...
    {
        await JourneyHasExpired_RendersErrorPage(c => c.EmailVerified(), additionalScopes: null, HttpMethod.Get, "/sign-in/register/resend-confirm-existing-account-email");
    }
    ...
    {
        await JourneyHasExpired_RendersErrorPage(c => c.EmailVerified(), additionalScopes: null, HttpMethod.Post, "/sign-in/register/resend-confirm-existing-account-email");
    }
