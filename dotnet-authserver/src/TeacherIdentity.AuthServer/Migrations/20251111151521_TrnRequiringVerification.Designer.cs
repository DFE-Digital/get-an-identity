...
namespace TeacherIdentity.AuthServer.Migrations
{
    ...
    [Migration("20251111151521_TrnRequiringVerification")]
    partial class TrnRequiringVerification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeacherIdentity.AuthServer.Models.Application", b =>
                {
                    ...
                    b.Property<bool>("BlockProhibitedTeachers")
            ...
            modelBuilder.Entity("TeacherIdentity.AuthServer.Models.TrnRequiringVerification", b =>
                {
                    b.Property<string>("Trn")
                        .HasMaxLength(7)
                        .HasColumnType("character(7)")
                    ...
                    b.HasKey("Trn")
                        .HasName("pk_trn_requiring_verification");

                    b.ToTable("trn_requiring_verification", (string)null);
                });
            ...
            modelBuilder.Entity("TeacherIdentity.AuthServer.Models.User", b =>
                {
                    ...
                    b.Property<bool>("TrnLookupSupportTicketCreated")
                        .HasColumnType("boolean")
                        .HasColumnName("trn_lookup_support_ticket_created");

                    b.Property<int?>("TrnVerificationLevel")
                        .HasColumnType("integer")
