...
{
    private static readonly char[] _ignoredCharacters = new[]
    {
        ' ',
        '\t',
        '\n',
    ...
    private static readonly string[] _internationPrefixies = new[]
    {
        "1",
        "7",
        "20",
    ...
    public bool Equals(MobileNumber? other) => other is not null && _normalizedValue.Equals(other._normalizedValue);

    public override bool Equals([NotNullWhen(true)] object? obj) => obj is MobileNumber other && Equals(other);
    ...
    public static bool operator !=(MobileNumber left, MobileNumber right) => !(left == right);

    public static explicit operator MobileNumber(string value) => Parse(value);
}
